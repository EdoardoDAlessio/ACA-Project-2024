...
HD_PWD='/home/users/edoardo.dalessio/code/av_omega/VersalAutomationTemplate/hw/_x/link/vivado/vpl/prj/prj.runs/ulp_inst_0_axi_ic_axi_noc_kernel0_S00_AXI_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ulp_inst_0_axi_ic_axi_noc_kernel0_S00_AXI_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ulp_inst_0_axi_ic_axi_noc_kernel0_S00_AXI_0.tcl
