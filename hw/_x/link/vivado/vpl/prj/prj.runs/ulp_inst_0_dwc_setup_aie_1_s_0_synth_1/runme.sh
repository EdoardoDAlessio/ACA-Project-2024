...
HD_PWD='/home/users/edoardo.dalessio/code/av_omega/VersalAutomationTemplate/hw/_x/link/vivado/vpl/prj/prj.runs/ulp_inst_0_dwc_setup_aie_1_s_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ulp_inst_0_dwc_setup_aie_1_s_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ulp_inst_0_dwc_setup_aie_1_s_0.tcl
