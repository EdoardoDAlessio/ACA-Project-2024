...
(* CORE_GENERATION_INFO = "bd_9d54,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_9d54,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ulp_inst_0_ai_engine_0_0.hwdef" *) 
module bd_9d54
   (M00_AXIS_tdata,
    M00_AXIS_tkeep,
    M00_AXIS_tlast,
  ...
  bd_9d54_pl_ai_ch_1_0 pl_ai_ch_1
       (.s_axis_aclk(aclk0_1),
