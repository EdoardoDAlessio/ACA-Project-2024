...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 1024, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "81", "EstimateLatencyMax" : "99",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "s", "Type" : "Axis", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111", "Port" : "s", "Inst_start_state" : "74", "Inst_end_state" : "75"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "81", "Max" : "99"}
	, {"Name" : "Interval", "Min" : "82", "Max" : "100"}
]}
