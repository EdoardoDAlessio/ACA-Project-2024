...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal trunc_ln_reg_193 : STD_LOGIC_VECTOR (56 downto 0);
    signal tmp_V_fu_139_p1 : STD_LOGIC_VECTOR (127 downto 0);
    signal tmp_V_reg_204 : STD_LOGIC_VECTOR (127 downto 0);
    signal tmp_reg_210 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln48_fu_152_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln48_reg_215 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln48_fu_185_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal select_ln48_reg_220 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state74 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state74 : signal is "none";
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_done : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_idle : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_ready : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TREADY : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TDATA : STD_LOGIC_VECTOR (127 downto 0);
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TVALID : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_ext_blocking_n : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_str_blocking_n : STD_LOGIC;
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_int_blocking_n : STD_LOGIC;
    ...
    signal grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state75 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state75 : signal is "none";
    signal sext_ln416_fu_129_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state72 : BOOLEAN;
    signal ap_block_state1 : BOOLEAN;
    signal shl_ln_fu_156_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal zext_ln48_fu_163_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln48_fu_167_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_1_fu_177_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln48_1_fu_173_p1 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    component setup_aie_setup_aie_Pipeline_VITIS_LOOP_48_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ...
        s_TREADY : IN STD_LOGIC;
        select_ln48 : IN STD_LOGIC_VECTOR (4 downto 0);
        tmp_V : IN STD_LOGIC_VECTOR (127 downto 0);
        s_TDATA : OUT STD_LOGIC_VECTOR (127 downto 0);
        s_TVALID : OUT STD_LOGIC;
...
begin
    grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111 : component setup_aie_setup_aie_Pipeline_VITIS_LOOP_48_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start,
        ap_done => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_done,
        ap_idle => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_idle,
        ap_ready => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_ready,
        s_TREADY => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TREADY,
        select_ln48 => select_ln48_reg_220,
        tmp_V => tmp_V_reg_204,
        s_TDATA => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TDATA,
        s_TVALID => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TVALID,
        ap_ext_blocking_n => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_ext_blocking_n,
        ap_str_blocking_n => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_str_blocking_n,
        ap_int_blocking_n => grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_int_blocking_n);
    ...
    grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state74)) then 
                    grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_ready = ap_const_logic_1)) then 
                    grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state74)) then
                    select_ln48_reg_220(4 downto 2) <= select_ln48_fu_185_p3(4 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state72)) then
                tmp_V_reg_204 <= tmp_V_fu_139_p1;
                tmp_reg_210 <= gmem0_RDATA(1 downto 1);
                trunc_ln48_reg_215 <= trunc_ln48_fu_152_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_reg_193 <= input_r(63 downto 7);
            end if;
        end if;
    end process;
    select_ln48_reg_220(1 downto 0) <= "00";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_CS_fsm_state72, ap_CS_fsm_state73, grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_done, gmem0_ARREADY, gmem0_RVALID, ap_CS_fsm_state75, ap_CS_fsm_state76, regslice_both_s_U_apdone_blk, s_TREADY_int_regslice)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state72 => 
                if ((not(((s_TREADY_int_regslice = ap_const_logic_0) or (gmem0_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then
                    ap_NS_fsm <= ap_ST_fsm_state73;
                else
                    ap_NS_fsm <= ap_ST_fsm_state72;
                end if;
            when ap_ST_fsm_state73 => 
                if (((s_TREADY_int_regslice = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state73))) then
            ...
            when ap_ST_fsm_state75 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state75) and (grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_done = ap_const_logic_1))) then
    ...
    add_ln48_fu_167_p2 <= std_logic_vector(unsigned(zext_ln48_fu_163_p1) + unsigned(ap_const_lv4_4));
    ...
    ap_ST_fsm_state72_blk_assign_proc : process(gmem0_RVALID, s_TREADY_int_regslice)
    begin
        if (((s_TREADY_int_regslice = ap_const_logic_0) or (gmem0_RVALID = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state73_blk_assign_proc : process(s_TREADY_int_regslice)
    begin
    ...
    ap_ST_fsm_state75_blk_assign_proc : process(grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_done)
    begin
        if ((grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_done = ap_const_logic_0)) then 
    ...
    ap_block_state72_assign_proc : process(gmem0_RVALID, s_TREADY_int_regslice)
    begin
                ap_block_state72 <= ((s_TREADY_int_regslice = ap_const_logic_0) or (gmem0_RVALID = ap_const_logic_0));
    end process;
    ...
    ap_sub_ext_blocking_0_assign_proc : process(grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_ext_blocking_n)
    begin
        if ((grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_ext_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_int_blocking_0_assign_proc : process(grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_int_blocking_n)
    begin
        if ((grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_int_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_str_blocking_0_assign_proc : process(grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_str_blocking_n)
    begin
        if ((grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_str_blocking_n = ap_const_logic_0)) then 
    ...
    gmem0_RREADY_assign_proc : process(ap_CS_fsm_state72, gmem0_RVALID, s_TREADY_int_regslice)
    begin
        if ((not(((s_TREADY_int_regslice = ap_const_logic_0) or (gmem0_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start <= grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_ap_start_reg;
    grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TREADY <= (s_TREADY_int_regslice and ap_CS_fsm_state75);

    s_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state72, ap_CS_fsm_state73, s_TREADY_int_regslice)
    begin
    ...
    s_TDATA_int_regslice_assign_proc : process(ap_CS_fsm_state72, tmp_V_fu_139_p1, grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TDATA, grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TVALID, gmem0_RVALID, ap_CS_fsm_state75, s_TREADY_int_regslice)
    begin
        if ((not(((s_TREADY_int_regslice = ap_const_logic_0) or (gmem0_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
            s_TDATA_int_regslice <= tmp_V_fu_139_p1;
        elsif (((grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state75))) then 
            s_TDATA_int_regslice <= grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TDATA;
        else 
    ...
    s_TVALID_int_regslice_assign_proc : process(ap_CS_fsm_state72, grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TVALID, gmem0_RVALID, ap_CS_fsm_state75, s_TREADY_int_regslice)
    begin
        if ((not(((s_TREADY_int_regslice = ap_const_logic_0) or (gmem0_RVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
            s_TVALID_int_regslice <= ap_const_logic_1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state75)) then 
            s_TVALID_int_regslice <= grp_setup_aie_Pipeline_VITIS_LOOP_48_1_fu_111_s_TVALID;
        else 
            s_TVALID_int_regslice <= ap_const_logic_0;
        end if; 
    end process;

    select_ln48_fu_185_p3 <= 
        tmp_1_fu_177_p3 when (tmp_reg_210(0) = '1') else 
        zext_ln48_1_fu_173_p1;
        sext_ln416_fu_129_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_193),64));

    shl_ln_fu_156_p3 <= (trunc_ln48_reg_215 & ap_const_lv2_0);
    ...
    tmp_1_fu_177_p3 <= (add_ln48_fu_167_p2 & ap_const_lv1_0);
    tmp_V_fu_139_p1 <= gmem0_RDATA(128 - 1 downto 0);
    trunc_ln48_fu_152_p1 <= gmem0_RDATA(1 - 1 downto 0);
    zext_ln48_1_fu_173_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln48_fu_167_p2),5));
    zext_ln48_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_156_p3),4));
end behav;
