set moduleName sink_from_aie_Pipeline_VITIS_LOOP_106_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sink_from_aie_Pipeline_VITIS_LOOP_106_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 512 regular {axi_master 1}  }
	{ sext_ln106 int 58 regular  }
	{ h1 int 32 regular {array 256 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "h1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ h1_address0 sc_out sc_lv 8 signal 2 } 
	{ h1_ce0 sc_out sc_logic 1 signal 2 } 
	{ h1_q0 sc_in sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	...
	h1 { ap_memory {  { h1_address0 mem_address 1 8 }  { h1_ce0 mem_ce 1 1 }  { h1_q0 mem_dout 0 32 } } }
}
