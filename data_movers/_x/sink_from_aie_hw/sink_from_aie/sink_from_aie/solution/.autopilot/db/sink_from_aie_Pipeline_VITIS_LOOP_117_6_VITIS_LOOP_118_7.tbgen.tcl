set moduleName sink_from_aie_Pipeline_VITIS_LOOP_117_6_VITIS_LOOP_118_7
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sink_from_aie_Pipeline_VITIS_LOOP_117_6_VITIS_LOOP_118_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 512 regular {axi_master 1}  }
	{ sext_ln117 int 58 regular  }
	{ joint int 32 regular {array 65536 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "joint", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ joint_address0 sc_out sc_lv 16 signal 2 } 
	{ joint_ce0 sc_out sc_logic 1 signal 2 } 
	{ joint_q0 sc_in sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	...
	joint { ap_memory {  { joint_address0 mem_address 1 16 }  { joint_ce0 mem_ce 1 1 }  { joint_q0 in_data 0 32 } } }
}
