; ModuleID = '/home/users/edoardo.dalessio/code/av_omega/VersalAutomationTemplate/data_movers/_x/sink_from_aie_hw/sink_from_aie/sink_from_aie/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sink_from_aie_ir(%"class.hls::stream<int, 0>"* noalias nocapture nonnull dereferenceable(4) %input_stream, i32* noalias nocapture nonnull %output, i64 %size) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_sink_from_aie_hw(%"class.hls::stream<int, 0>"* %input_stream_copy, i32* %1, i64 %size)
...
declare void @apatb_sink_from_aie_hw(%"class.hls::stream<int, 0>"*, i32*, i64)
...
define void @sink_from_aie_hw_stub_wrapper(%"class.hls::stream<int, 0>"*, i32*, i64) #7 {
entry:
  ...
  call void @sink_from_aie_hw_stub(%"class.hls::stream<int, 0>"* %0, i32* %4, i64 %2)
  call void @copy_in(%"class.hls::stream<int, 0>"* null, %"class.hls::stream<int, 0>"* %0, [100 x i32]* null, [100 x i32]* %3)
  ret void
}

declare void @sink_from_aie_hw_stub(%"class.hls::stream<int, 0>"*, i32*, i64)
