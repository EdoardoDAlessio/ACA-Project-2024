...
void XSink_from_aie_Set_size(XSink_from_aie *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XSink_from_aie_WriteReg(InstancePtr->Control_BaseAddress, XSINK_FROM_AIE_CONTROL_ADDR_SIZE_DATA, (u32)(Data));
    XSink_from_aie_WriteReg(InstancePtr->Control_BaseAddress, XSINK_FROM_AIE_CONTROL_ADDR_SIZE_DATA + 4, (u32)(Data >> 32));
}

u64 XSink_from_aie_Get_size(XSink_from_aie *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XSink_from_aie_ReadReg(InstancePtr->Control_BaseAddress, XSINK_FROM_AIE_CONTROL_ADDR_SIZE_DATA + 4) << 32;
    return Data;
}
